...
export const categoryImages = {
  ...
  kitchen: [
    ...
    img("1594035910387-fea47794261f", "Detail shot of a kitchen accessory"),
    img("1571066811602-716837d681de", "Close-up of kitchenware on a counter"),
  ],
  office: [
  ...
  fitness: [
    img("1571875257727-256c39da42af", "Rolled yoga mat on a studio floor"),
    img("1544367567-0f2fcb009e0b", "Fitness gear arranged neatly"),
    img("1607082349566-187342175e2f", "Close-up of workout equipment"),
    img("1571781926291-c477ebfd024b", "Fitness accessories flatlay"),
    img("1517423440428-a5a00ad493e8", "Gym equipment detail shot"),
    img("1580618672591-eb180b1a973f", "Active lifestyle gear on display"),
  ],
  lifestyle: [
    ...
    img("1585386959984-a4155224a1ad", "Candle and textiles styled together"),
  ...
  beauty: [
    img("1512496015851-a90fb38ba796", "Makeup flatlay with cosmetics"),
    img("1522335789203-aabd1fc54bc9", "Beauty products styled on marble"),
    ...
    img("1523293182086-7651a899d37f", "Fragrance bottle on a clean surface"),
  ],
  electronics: [
    img("1585155770447-2f66e2a397b5", "Wireless earbuds tossed in the air"),
    img("1519558260268-cde7e03a0152", "Smart speaker beside a smartphone"),
    img("1591370874773-6702e8f12fd8", "Multi-monitor desk setup"),
    img("1585790050230-5dd28404ccb9", "Two tablets on a clean desk"),
    img("1610945415295-d9bbf067e59c", "Smartphone resting on its box"),
...
export const instagramGallery = [
  ...
  img("1523293182086-7651a899d37f", "@zeevara.co — fragrance styling", 800, 800),
];
